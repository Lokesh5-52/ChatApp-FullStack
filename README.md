...
A professional, full-stack chat application featuring a **Spring Boot** backend and a **WhatsApp-inspired** frontend. This project demonstrates secure user authentication, JWT handling, and modern architectural patterns.
